...
public class ClientListView extends StandardView {
    ...
    private Optional<Component> createContactInformationItem(@Nullable String value, Icon icon, Function<String, Component> valueRenderer) {
        icon.addClassNames(LumoUtility.Flex.SHRINK_NONE);
